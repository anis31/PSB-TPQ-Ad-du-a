							...
							<div class="profile-right">
								...
								<div class="custom-tabs-line tabs-line-bottom left-aligned">
									<ul class="nav" role="tablist">
										<li class=""><a href="#tab-bottom-left1" role="tab" data-toggle="tab" aria-expanded="false">Progres Tahfidz</a></li>
										<li class="active"><a href="#tab-bottom-left2" role="tab" data-toggle="tab" aria-expanded="true">Progres Tartil</a></li>
									</ul>
								</div>
